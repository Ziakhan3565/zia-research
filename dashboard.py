...
# ============================================================
# 1. STREAMLIT CONFIG & PERSISTENT CSV
# ============================================================
...
def get_all_tri_levels(symbol):
    ...
    yearly_candle = (
        fetch_tri_yearly_candle(
            symbol
        )
    )

    yearly_levels = (
        calculate_tri_levels(
            yearly_candle
        )
    )
        ...
        st.markdown(
            ...
            <div class="metric-card">
                ...
                ">
                    ...
                    • <b>HAWKES:</b>
                    Measures aggressive order clustering
                    and arrival rates.<br>

                    • <b>BOOK_IMB:</b>
                    Computes real-time depth pressure
                    across bids & asks.<br>

                    • <b>Dynamic Weights:</b>
                    Optimized linear blending
                    for robust signals.
